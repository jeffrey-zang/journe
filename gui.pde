...
public void createGUI() {
  ...
  TextBox = new GTextField(this, 0, chat.height - 60, chat.width, 60, G4P.SCROLLBARS_NONE);
  TextBox.setPromptText("Press here to send a message...");
  TextBox.setOpaque(true);
  TextBox.addEventHandler(this, "TextBoxChange");
  messageTab = new GButton(this, 0, 0, 133.33, 30);
  messageTab.setText("Messages");
  messageTab.addEventHandler(this, "goMessage");
  SettingsTab = new GButton(this, 266.66, 0, 133.33, 30);
  SettingsTab.setText("Settings");
  SettingsTab.addEventHandler(this, "goSettings");
  StatsTab = new GButton(this, 133.33, 0, 133.33, 30);
  StatsTab.setText("Stats");
  StatsTab.addEventHandler(this, "goStats");
  messages = new GTextArea(this, 0, 30, chat.width, 570, G4P.SCROLLBARS_VERTICAL_ONLY);
  ...
  PromptTime = new GCustomSlider(this, 0, 190, chat.width, 50, "grey_blue");
